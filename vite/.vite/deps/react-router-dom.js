...
// node_modules/.deno/preact@10.26.0/node_modules/preact/compat/dist/compat.module.js
function g2(n, t) {
...
// node_modules/.deno/react-router@7.1.5_1/node_modules/react-router/dist/development/chunk-IR6S3I6Y.mjs
...
function StreamTransfer({
  ...
  if (done) {
    ...
    return _(k, null, scriptTag, _(P2, null, _(
      StreamTransfer,
      {
        context,
...
function preventInvalidServerHandlerCall(type, route, isSpaMode) {
  if (isSpaMode) {
    let fn22 = type === "action" ? "serverAction()" : "serverLoader()";
    let msg2 = `You cannot call ${fn22} in SPA Mode (routeId: "${route.id}")`;
    console.error(msg2);
    throw new ErrorResponseImpl(400, "Bad Request", new Error(msg2), true);
  }
  let fn2 = type === "action" ? "serverAction()" : "serverLoader()";
  let msg = `You are trying to call ${fn2} on a route that does not have a server ${type} (routeId: "${route.id}")`;
...
function getShouldRevalidateFunction(route, routeId, needsRevalidation) {
  ...
  if (route.shouldRevalidate) {
    let fn2 = route.shouldRevalidate;
    return (opts) => fn2({ ...opts, defaultShouldRevalidate: true });
  }
...
function PrefetchPageLinksImpl({
  ...
  return _(k, null, dataHrefs.map((href) => _("link", { key: href, rel: "prefetch", as: "fetch", href, ...linkProps })), moduleHrefs.map((href) => _("link", { key: href, rel: "modulepreload", href, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => (
...
var Link = D2(
  function LinkWithRef({
    ...
    return shouldPrefetch && !isAbsolute ? _(k, null, link, _(PrefetchPageLinks, { page: href })) : link;
  }
);
...
function ServerRouter({
  ...
  ), context.serverHandoffStream ? _(P2, null, _(
    StreamTransfer,
    {
      context,
      identifier: 0,
...
// node_modules/.deno/react-router@7.1.5_1/node_modules/react-router/dist/development/dom-export.mjs
