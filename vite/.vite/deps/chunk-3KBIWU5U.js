// node_modules/.deno/preact@10.26.0/node_modules/preact/dist/preact.module.js
var n;
var l;
var t;
var u;
...
function j(n2, t2, u2, i2, r2, o2, e2, f2, c2, s2) {
  var a2, h2, p2, v2, y2, _2, m2, b, S2, C2, M2, $2, P2, A2, H2, L2, T2, F2 = t2.type;
  ...
  n: if ("function" == typeof F2) try {
    if (b = t2.props, S2 = "prototype" in F2 && F2.prototype.render, C2 = (a2 = F2.contextType) && i2[a2.__c], M2 = a2 ? C2 ? C2.props.value : a2.__ : i2, u2.__c ? m2 = (h2 = t2.__c = u2.__c).__ = h2.__E : (S2 ? t2.__c = h2 = new F2(b, M2) : (t2.__c = h2 = new x(b, M2), h2.constructor = F2, h2.render = B), C2 && C2.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != F2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, F2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y2 = h2.state, h2.__v = t2, p2) S2 && null == F2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), S2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
...
//# sourceMappingURL=chunk-3KBIWU5U.js.map
